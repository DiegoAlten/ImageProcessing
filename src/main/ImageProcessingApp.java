...
public class ImageProcessingApp {
    ...
    private void applyGrayscale() {
        ...
        transformedImage = FilterManager.grayscale(originalImage); // Chamando a função de outro pacote
    ...
    private void applyRotate() {
    	...
    	transformedImage = TransformManager.rotate(originalImage, angle); // Chamando a função de outro pacote
        transformedImageLabel.setIcon(new ImageIcon(transformedImage)); // Atualizando a tela
    }
    ...
    private void applyTranslate() {
    	...
    	transformedImage = TransformManager.translated(originalImage); // Chamando a função de outro pacote
        transformedImageLabel.setIcon(new ImageIcon(transformedImage)); // Atualizando a tela
    }
    ...
    private void applyMirror() {
    	...
    	transformedImage = TransformManager.mirror(originalImage); // Chamando a função de outro pacote
        transformedImageLabel.setIcon(new ImageIcon(transformedImage)); // Atualizando a tela
    }
